...
then
    ...
    curl_to_dir "https://raw.githubusercontent.com/Altoyda/Test_Ubuntu_VM/main/addons/deSEC" "hook.sh" "$SCRIPTS"/deSEC
    chmod +x "$SCRIPTS"/deSEC/hook.sh
    curl_to_dir "https://raw.githubusercontent.com/Altoyda/Test_Ubuntu_VM/main/addons/deSEC" ".dedynauth" "$SCRIPTS"/deSEC
